        ...
        <Html>
            ...
            <Tailwind>
                <Body className="bg-white my-auto mx-auto font-sans px-2">
                    <Container
                        style={container}
                        className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[450px]">
                        ...
                        <Text className="text-black text-[14px] leading-[24px]">
                            The WebdriverIO team would like to thank you deeply
                            for your contribution on pull request{' '}
                            <Link
                                href={prURL}
                            ...
                            everyone who has taken time to improve the project.
                        </Text>
                        <Text className="text-black text-[14px] leading-[24px]">
                            The reviewer of your pull request has granted you an
                            expense of <strong>${expenseAmount}</strong> 💸
                        </Text>
                        <Text className="text-black text-[14px] leading-[24px]">
                            Submit your expense via OpenCollective by clicking
                            the button below. Create an account, select{' '}
                        ...
                        />
                        <Text className="text-black text-[14px] leading-[24px]">
                            With this key we ensure that the author of the pull
                            request (you) can authenticate this expense, so
                            please don't share it with anyone. Lastly, make sure
                            all your data is correct and click{' '}
                            <strong>Submit expense</strong>. Once your expense
                            has been approved, you will receive the money within
                            1-2 weeks.
                        </Text>
                        ...
                        <Text className="text-[#666666] text-[12px] leading-[24px]">
                            Your are eligible to expense your work within the
                            next <strong>30 days</strong>. If you have any
                            questions, please reply to this email. You can find
                            more information about our expense policy in our{' '}
                            <Link
                                href={
